<?php
    ...
    class DB {
        ...
        private $_pdo, $_query, $_error = false, $_result, $_count = 0, $_lastInsertID = null, $_lastQuery = null;
        ...
        public function query($sql, $params = []){
            ...
            $this->_lastQuery = $this->_query->queryString;
        ...
        protected function _read($table, $params = []){
            ...
            if(!$this->query($sql, $bind)->error()){
                if(!is_countable($this->_result)) return false;
                return true;
            }
            return false;
